...
class Config(BaseModel):
    ...
    direct_gamma: float = 0.1  # schedular gamma
    ...
    inverse_gamma: float = 0.1  # schedular gamma
    ...
    def load_config_from_file(self):
        ...
        self.direct_milestones = (
            self.direct_milestones
            or inverse_parser["direct_milestones"]
            or "25,50,130,140,150"
        )
        ...
        self.inverse_milestones = (
            self.inverse_milestones
            or inverse_parser["inverse_milestones"]
            or "25,50,130,140,150"
        )
