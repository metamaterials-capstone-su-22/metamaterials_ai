...
class Config(BaseModel):
    ...
    direct_arch = "mlpmixer"  # options 'mlpmixer', 'resnet1d','ann', 'cnn,
    ...
    direct_saved_ckpt: str | None = 'D-1-res-ann-stainless.ckpt'  # = "D-0.9-res-ann-inconel.ckpt"  # Default None
    inverse_arch = "mlpmixer"  # options 'MLPMixer', 'resnet1d','ann', 'res-ann', 'cnn,
    ...
    # Default= None: It should be under'{work_folder}/saved_best'
    inverse_saved_ckpt: str | None = 'I-1-res-ann-stainless.ckpt' #str | None =  # Default: None
